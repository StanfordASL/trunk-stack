...
class MotorNode(Node):
    def __init__(self):
        ...
        self.rest_positions = np.array([146.60, 124.54, 137.81, 109.69, 126.74, 149.59])
        ...
        self.rest_position_trunk = np.array([0.09633971005678177, -0.10842441767454147, 0.10407043248414993,
